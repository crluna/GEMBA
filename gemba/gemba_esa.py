def esa_fewshot(few_shots):
    prompts = [
        {
            "role": "system",
            "content": "Your task is to identify machine translation errors and assess the quality of the translation.",
        }
    ]
...
TEMPLATE_GEMBA_ESA_ERROR_SPANS = esa_fewshot(
    [esa_few_shots["ende"], esa_few_shots["encs"], esa_few_shots["zhen"]]
)
